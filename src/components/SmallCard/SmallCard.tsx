...
function SmallCard({ data, variation }: CardProp) {
  return (
    <>
      {variation === "default" && (
        <div className="h-full md:p-8 p-4 bg_primary flex gap-4 flex-col">
          <Image
            width={48}
            height={48}
            src={data.icon.path}
          ...
          <div className="flex flex-col gap-2">
            <h3 className="font-medium text-xl leading-7">{data.title}</h3>
      ...
      {variation === "Align Center" && (
        <div className="h-full md:p-8 p-4 bg_primary flex gap-4 flex-col items-center">
          ...
          />
          <div className="flex flex-col gap-2">
            <h3 className="font-bold leading-4 text-center text_primary">
              {data.title}
            </h3>
            <p className="font-semibold leading-[26px] text-center">
              {data.description}
            </p>
          </div>
        </div>
